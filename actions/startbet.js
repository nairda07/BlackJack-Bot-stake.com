async function startbet(page, session, betamount) {
    const response = await page.evaluate(async (sessionCookies, amount) => {
        const requestData = {
            "query": "mutation BlackjackBet($amount: Float!, $currency: CurrencyEnum!, $identifier: String!) {\n  blackjackBet(amount: $amount, currency: $currency, identifier: $identifier) {\n    ...CasinoBet\n    state {\n      ...CasinoGameBlackjack\n    }\n  }\n}\n\nfragment CasinoBet on CasinoBet {\n  id\n  active\n  payoutMultiplier\n  amountMultiplier\n  amount\n  payout\n  updatedAt\n  currency\n  game\n  user {\n    id\n    name\n  }\n}\n\nfragment CasinoGameBlackjack on CasinoGameBlackjack {\n  player {\n    value\n    actions\n    cards {\n      rank\n      suit\n    }\n  }\n  dealer {\n    value\n    actions\n    cards {\n      rank\n      suit\n    }\n  }\n}\n",
            "variables": {
